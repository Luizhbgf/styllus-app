...
export default function StaffNotificacoes() {
  const [notificacoes, setNotificacoes] = useState([
    {
      id: 1,
      type: "agendamento",
      title: "Novo Agendamento",
      message: "Maria Silva agendou um corte de cabelo para amanhã às 14:30",
      time: "5 min atrás",
      read: false,
      icon: Calendar,
      color: "text-blue-600",
    },
    {
      ...
      message: "Carla Santos cancelou o agendamento de coloração de hoje",
      time: "1 hora atrás",
      read: false,
      icon: Calendar,
      color: "text-red-600",
    },
    {
      ...
      message: "Fernanda Lima avaliou seu serviço com 5 estrelas",
      time: "2 horas atrás",
      read: true,
      icon: Star,
    ...
    },
    {
      ...
      message: "Pagamento de R$ 80,00 de Juliana Martins foi confirmado",
      time: "3 horas atrás",
      read: true,
      icon: CreditCard,
    ...
    },
    {
      ...
      type: "mensagem",
      title: "Nova Mensagem",
      message: "Amanda Souza enviou uma mensagem",
      time: "1 dia atrás",
      read: true,
      icon: MessageSquare,
    ...
    },
    {
      ...
      type: "cliente",
      title: "Novo Cliente",
      message: "Patricia Oliveira se cadastrou e quer agendar um horário",
      time: "2 dias atrás",
      read: true,
      icon: User,
      color: "text-blue-600",
    },
    {
      ...
      message: "Você tem 3 agendamentos amanhã. Prepare-se!",
      time: "1 semana atrás",
      read: true,
      icon: Bell,
  ...
  const notificacaosPorTipo = {
    ...
    agendamentos: notificacoes.filter((n) => n.type === "agendamento" || n.type === "cancelamento"),
    avaliacoes: notificacoes.filter((n) => n.type === "avaliacao"),
    pagamentos: notificacoes.filter((n) => n.type === "pagamento"),
    mensagens: notificacoes.filter((n) => n.type === "mensagem"),
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{notificacaosPorTipo.naoLidas.length}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{notificacaosPorTipo.agendamentos.length}</div>
            <p className="text-xs text-muted-foreground">Relacionados à agenda</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{notificacaosPorTipo.avaliacoes.length}</div>
      ...
      <Tabs defaultValue="todas">
        <TabsList>
          ...
          <TabsTrigger value="avaliacoes">Avaliações ({notificacaosPorTipo.avaliacoes.length})</TabsTrigger>
        ...
        <TabsContent value="configuracoes" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              {[
                { key: "agendamentos", label: "Agendamentos", desc: "Novos agendamentos e confirmações" },
                { key: "cancelamentos", label: "Cancelamentos", desc: "Cancelamentos e reagendamentos" },
                { key: "avaliacoes", label: "Avaliações", desc: "Novas avaliações de clientes" },
                { key: "pagamentos", label: "Pagamentos", desc: "Confirmações de pagamento" },
                { key: "mensagens", label: "Mensagens", desc: "Mensagens de clientes" },
                { key: "lembretes", label: "Lembretes", desc: "Lembretes de agendamentos e tarefas" },
              ].map((categoria) => (
